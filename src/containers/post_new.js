  ...
  renderInput(field) {
    ...
    return (
      <div className={className}>
        ...
        <input className={klass} type="text" {...field.input} />
  ...
  renderNote(field) {
    return (
      <div className="form-group">
        ...
        <textarea className="form-control form-textarea" {...field.input} />
      </div>
    );
  }
    ...
    return (
      <div>
        ...
        >
          ...
          />
          <Field label="Note" name="note" component={this.renderNote} />
          <div className="m-audio form-group">
            ...
            <audio
              className="mt-1"
              controls
              src={this.state.blob ? this.state.blob.blobURL : ""}
            />
          </div>
          <div className="mt-5">
